...
Создается на основе всех изменений в репозитории, с использованием ветки main и на ежедневной основе. Pull request'ы из этого репозитория публикуются под названием core/pr:<номер PR> для целей тестирования.
